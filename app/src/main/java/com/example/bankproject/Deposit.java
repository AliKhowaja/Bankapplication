...
public class Deposit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        deposit = findViewById(R.id.depositbut);
                        ...
                        ref1.updateChildren(result).addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                if(task.isSuccessful()){
                                    Toast.makeText(Deposit.this,"Successfully Deposited, Thankyou For Choosing US!.", Toast.LENGTH_LONG).show();
                                }
